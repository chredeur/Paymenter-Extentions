...
| --- | --- | --- | --- |
| [PterodactylAdvanced](extensions/Servers/PterodactylAdvanced) | Server | Extension Pterodactyl : montages automatiques, connexion automatique au panel et comptes gérés | 2.4.0 |
